...
const defaultContasPagar: Conta[] = [
...
const defaultContasReceber: Conta[] = [
...
export default function FinanceiroSection({
  contasPagar = defaultContasPagar,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button size="sm" className="bg-[#1672d6] hover:bg-[#1672d6]/90" onClick={onNovaConta}>
