...
interface NoticiasInternasProps {
  noticias?: Noticia[];
  eventos?: Array<{ titulo: string; data: string; tipo: string }>;
  showEventos?: boolean;
}
          ...
          >
            ...
            <div className="flex items-center gap-2 mt-4 pt-3 border-t border-border/60">
              <Avatar className="h-6 w-6">
                ...
                <AvatarFallback className="text-xs bg-[#1672d6]/10 text-[#1672d6]">
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "bg-card hover:border-[#1672d6]/30 hover:shadow-md transition-all cursor-pointer",
        `border-l-4 ${config.highlight}`
      )}
    >
      {/* Icon */}
          ...
          <Card className="border-border/60">
            <CardHeader>
              <CardTitle className="text-xl font-semibold flex items-center gap-2">
                <Megaphone className="w-5 h-5 text-[#1672d6]" />
                Destaques
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-border/60 mt-8">
            <CardHeader>
              <CardTitle className="text-lg font-semibold flex items-center gap-2">
                <Calendar className="w-5 h-5 text-[#1672d6]" />
                Próximos Eventos
              </CardTitle>
            </CardHeader>
            <CardContent>
                ...
                {eventos.map((evento, index) => (
                  ...
                  >
                    <div className="p-2 rounded-lg bg-[#1672d6]/10">
                      <Calendar className="w-4 h-4 text-[#1672d6]" />
                    </div>
                    <div>
