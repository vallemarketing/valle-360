...
export const AIInputSubmit = ({
  ...
  <Button
    ...
    variant={variant}
    size={size}
    className={cn('gap-1.5 bg-[#1672d6] hover:bg-[#1260b5] text-white', className)}
    {...props}
  />
);
...
export const AIInputModelSelectTrigger = ({
  ...
  <SelectTrigger
    className={cn(
      'border-none bg-transparent font-medium text-muted-foreground shadow-none transition-colors h-8 w-auto',
